/**
 * Golden scenarios — compress/decompress tool observable contracts (C10).
 *
...
const SID = "golden-g-tool-01";

/** Full tool config with a relaxed protection window (boundary ~18). */
function toolConfig() {
  return {
    protectedMessages: 5,
    releasedPercent: 10,
