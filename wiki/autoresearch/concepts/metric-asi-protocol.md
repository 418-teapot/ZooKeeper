...
METRIC/ASI 协议是 [autoresearch 扩展](autoresearch/concepts/autoresearch-extension-loop.md)的度量与元数据交换约定，在 [autoresearch 设计文档](autoresearch/sources/rfc/autoresearch-design.md)的 §10 中有完整定义。协议提供的主指标是 [MAD 置信度](autoresearch/concepts/mad-confidence.md)算法的输入。
...
- `autoresearch/sources/rfc/autoresearch-design.md` §10 METRIC/ASI 协议
