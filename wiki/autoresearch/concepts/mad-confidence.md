...
MAD 置信度算法是 [autoresearch 扩展](autoresearch/concepts/autoresearch-extension-loop.md)中判断实验改善是否"真实"的核心数学组件，在 [autoresearch 设计文档](autoresearch/sources/rfc/autoresearch-design.md)的 §7 中有完整定义。它回答"这次优化是真实信号还是随机噪声"的问题。
...
- `autoresearch/sources/rfc/autoresearch-design.md` §7 状态管理
