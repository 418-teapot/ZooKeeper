...
### [固定时间预算](autoresearch/concepts/fixed-time-budget-evaluation.md) vs 固定步数/epoch
...
### [单文件修改](autoresearch/concepts/single-file-modification.md) vs 全仓库修改
...
| **故障定位** | 崩溃必在 [train.py](autoresearch/entities/autoresearch-train-py.md) | 可能源于任何文件 |
...
| **策略迭代** | 通过编辑 [program.md](autoresearch/entities/autoresearch-program-md.md) | 通过对话和代码审查 |
...
- [program.md](autoresearch/entities/autoresearch-program-md.md) 中的约束和准则定义
